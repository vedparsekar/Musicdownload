...
$Status="1";
$sql = "UPDATE payment SET status=:Status WHERE  pid=:requestid";
$query = $dbh->prepare($sql);
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Paid Songs not confirmed requests</h2>				
...
$sql = "SELECT payment.*,tblusers.*,tblsongs.* from payment join tblsongs on payment.songid=tblsongs.songid join tblusers on  payment.userid=tblusers.userid where payment.status='0'";
$query = $dbh -> prepare($sql);
$query->execute();
...
<a href="paidsongrequest.php?requestid=<?php echo htmlentities($result->pid);?>" onclick="return confirm('Do you really want to Confirm this booking')"><button class="btn btn-primary" name="submit" type="submit"> Confirm</button></a>
