...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->procatname);?></td>
											<td><?php echo htmlentities($result->price);?></td>
											<td><?php echo htmlentities($result->stock);?></td>
		<td><a href="editproduct.php?id=<?php echo $result->proid;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="emanageproduct.php?del=<?php echo $result->proid;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
