			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Paid Song</h2>
...
<?php
 $sql = "SELECT tblsongs.SongTitle,tblsongs.File,tblcat.catname,tblcat.cid,tblsongs.Price,tblsongs.songid from tblsongs join tblcat on tblcat.cid=tblsongs.cid where Price!='0'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
	...
	<audio controls><source src="mp3/<?php echo htmlentities($result->File);?>" class="img-responsive" type="audio/mpeg"/> </audio> 
											...
											<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Music_Downloadd/admin/songimage.php?imageid=<?php echo ($result->songid);?>');">View Image </a>
		<td><a href="edit-song.php?id=<?php echo $result->songid;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="paidsongs.php?del=<?php echo $result->songid;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
