...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      <td colspan="2" class="fontkink2" style="padding-left:0px;"><div class="fontpink2"> <b>Admin Address: </b></div></td>
      ...
      <td colspan="2" ">  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
            ...
            <tbody>
<?php
$admaddid=intval($_GET['admaddid']);
$sql = "SELECT * from admin where id=:admaddid";
$query = $dbh -> prepare($sql);
$query->bindParam(':admaddid',$admaddid, PDO::PARAM_STR);
...
{  ?>
        <tr class="product-listing-m gray-bg">
            ...
            <td class="fontkink1"><?php echo htmlentities($result->address);?></td>
