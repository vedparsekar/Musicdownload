...
{
	echo'You are NOT ACTIVE and You Do not have the right to change anythings please contact active admins to active you.';
}
else{
	?>
						<div class="row">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT songid from tblsongs ";
$query1 = $dbh -> prepare($sql1);;
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalsongs=$query1->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalsongs);?></div>
													<div class="stat-panel-title text-uppercase">Listed Songs</div>
												</div>
											</div>
											<a href="manage-song.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
?>												
											...
											<a href="manage-cat.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql6 ="SELECT queryid from contactusquery ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql5 ="SELECT fid from tbltestimonial ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql5 ="SELECT proid from product";
$query5= $dbh -> prepare($sql5);
$query5->execute();
$results5=$query5->fetchAll(PDO::FETCH_OBJ);
$proid=$query5->rowCount();
?>

													<div class="stat-panel-number h1 "><?php echo htmlentities($proid);?></div>
