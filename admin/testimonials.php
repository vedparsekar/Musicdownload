...
<?php $sql = "SELECT tblusers.uname,tblusers.uemailid,tbltestimonial.userid,tbltestimonial.message,tbltestimonial.PostingDate,tbltestimonial.Status,tbltestimonial.fid from tbltestimonial join tblusers on tblusers.userid=tbltestimonial.userid";
$query = $dbh -> prepare($sql);
$query->execute();
