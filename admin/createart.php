...
{
$artist=$_POST['artist'];
$sql="INSERT INTO  artist(artistname) VALUES(:artist)";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Create Artist</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="artist" id="category" required>
												</div>
											</div>
