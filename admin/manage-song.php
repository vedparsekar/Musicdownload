			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Admin's Songs</h2>
...
<?php $sql = "SELECT tblsongs.SongTitle,tblsongs.File,tblcat.catname,tblcat.cid,tblsongs.Price,tblsongs.songid from tblsongs join tblcat on tblcat.cid=tblsongs.cid where userid='0'";
$query = $dbh -> prepare($sql);
$query->execute();
...
<a href="manage-song.php?del=<?php echo $result->songid;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
