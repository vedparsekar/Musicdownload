...
<head>
	...
	<title>Music Download |Admin Manage admins   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage register Admins</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Register Admins</div>
...
<?php $sql = "SELECT * from  admin where astatus='0'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{
	?>										
	<a href="deactiveadmins.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Active')"> Active</a>
<?php }
 else {?>
			
<a href="deactiveadmins.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Inactive')"> Inactive</a>
