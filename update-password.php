...
$email=$_SESSION['login'];
  $sql ="SELECT password FROM tblusers WHERE uemailid=:email and password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblusers set password=:newpassword where uemailid=:email";
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"><! <img src="assets/images/do.png" alt="image"><span class='glyphicon glyphicon-user' style='font-size: 70px;'></span>
      </div>
