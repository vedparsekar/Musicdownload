...
$userId=$_POST['userId'];
$sql="INSERT INTO  tbltestimonial(userid,message) VALUES(:userId,:testimonoial)";
...
<title>Music Download |Give feedback</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Feedback</h5>
