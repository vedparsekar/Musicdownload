...
move_uploaded_file($_FILES["img"]["tmp_name"],"admin/img/".$_FILES["img"]["name"]);
move_uploaded_file($_FILES["img2"]["tmp_name"],"admin/mp3/".$_FILES["img2"]["name"]);

$sql="INSERT INTO tblsongs(SongTitle,cid,status,lyrics,Price,simage,File,userid) VALUES(:songtitle,:cn,0,:sov,:price,:simage,:vimage2,:userId)";
...
if($lastInsertId)
{
$msg="Song submitted successfully";
}
else 
{
...
<title>Music Download |Post song</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Form</h5>
...
<?php 
$sql = "SELECT * from tblusers where uemailid='{$_SESSION['email']}'";
$query= $dbh -> prepare($sql);
...
foreach($results as $result)
	{
?>
	<input type="hidden" readonly name="userId" value="<?php echo htmlentities($result->userid);?>">
	 <?php }}?>		
</div> <br>
