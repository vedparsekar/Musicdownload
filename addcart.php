...
{
	//$sql1="UPDATE product set stock=4 where proid=(select proid from user_cart where userid=$u and cartstatus=0)";
...
echo "<script type='text/javascript'>window.location.href='addcart.php';</script>";
		...
		<div class="col-md-9 cart-items">
			<h6>CART<span class="glyphicon glyphicon-shopping-cart"></span></h6>
...
$sql="INSERT INTO  user_cart(userid,proid,quantity,total) VALUES(:u,:pid,:q,:total)";
$query = $dbh->prepare($sql);
