...
$sql = "SELECT * FROM tblsongs where cid=4 and Price=0 and status=1";
...
if ($result->num_rows > 0) {
   ...
   session_start();
    ...
    while($row = $result->fetch_assoc()) {
       ...
       $sid=$row['songid'];
         echo "<tr><td class='shrin'><a href='songinfo.php?id=$sid'><img src='admin/img/".$row['simage']."' height=30px width=30px/></td><td>". $row["SongTitle"]."&nbsp&nbsp"."</a><br/><small>".$row["artist"]."</small>".
