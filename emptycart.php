...
$sql = "SELECT sum(total),count(proid) FROM user_cart where userid=$u and cartstatus=0";
...
$pid=$_GET['p'];
$sql = "delete from user_cart  WHERE userid=$u and cartstatus=0";
//$sql="INSERT INTO  user_cart(userid,proid,quantity) VALUES(:u,:pid,:q)";
...
echo "<br/><div align='center'><h3><span class='glyphicon glyphicon-ok-sign' style='color: #00c851;'></span> DONE</h3><br/><a href='index1.php'><button type=button class='btn btn-xs'><span class='glyphicon glyphicon-circle-arrow-left'></span> BACK</button></a></div><br/>";
?>
