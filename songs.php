...
$snm= $_GET['id'];
$p=$_GET['pc'];
echo "<div align='center'><img src='pics/$p'class='img-circle' height=150px width=150px/></div>";

$sql = "SELECT * FROM tblsongs where artist='$snm'";
...
if ($result->num_rows > 0) {
  ...
  echo "<h1>$snm</h1>";
   ...
   $sid=$row['id'];
         echo "<tr><td class='shrin'><a href='songinfo.php?id=$sid'><img src='admin/img/".$row['SongImage']."' height=30px width=30px/></a></td><td>". $row["SongTitle"]."&nbsp&nbsp"."<br/><small>".$row["artist"]."</small>".
